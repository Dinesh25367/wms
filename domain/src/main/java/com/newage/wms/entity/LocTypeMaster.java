...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="wms_loc_type_master",schema = "tenant_default",uniqueConstraints = {
        @UniqueConstraint(columnNames = {"code"}, name = "UK_LOC_TYPE_CODE")})
public class LocTypeMaster extends Auditable<String>{
