...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="wms_storage_type_master",schema = "tenant_default",uniqueConstraints = {
        @UniqueConstraint(columnNames = {"code"}, name = "UK_STORAGE_TYPE_CODE")})
public class StorageTypeMaster extends Auditable<String>{
