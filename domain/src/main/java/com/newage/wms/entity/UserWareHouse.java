...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="wms_user_warehouse",schema = "tenant_default")
public class UserWareHouse extends Auditable<String>{
    ...
    @Column(name = "grn_cancel",length = 30)
    private String grnCancel;

    @Column(name = "asn_cancel", length = 30)
    private String asnCancel;
